...
After cleaning the data, it has a total of `r nrow(homicide_data)` entries with demographic variables such as victim names, date of incident, victime race, age, sex, and location of incident, etc. Additionally, the `city_state` variable was created to combine and output location nicely; `resolution` was also updated.
